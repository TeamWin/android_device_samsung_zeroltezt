...
TARGET_PREBUILT_KERNEL := device/samsung/zeroltezt/Image
TARGET_PREBUILT_DTB := device/samsung/zeroltezt/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/zeroltezt/bootimg.mk
